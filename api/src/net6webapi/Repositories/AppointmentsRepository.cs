...
namespace net6webapi.Repositories
{
    ...
    public class AppointmentsRepository : IAppointmentsRepository
    {
        ...
        public async Task<Appointment?> GetById(int id)
        {
            ...
            return await _appointments.SingleOrDefaultAsync(i => i.Id == id);
        }
        ...
        public async void Checkin(int id, int appointmentStatusId)
        {
            ...
            var appointmentStatus = await _appointmentsStatusService.GetById(appointmentStatusId);
            if (appointmentStatus == null) throw new KeyNotFoundException();
            
            var appointment = await GetById(id);
            if (appointment == null) throw new KeyNotFoundException();
