...
namespace net6webapi.Models.DummyDataDBInitializer
{
    public class DbInitializer
    {
        public static void Initialize(AppDBContext context)
        {
            ...
            {
                new Pacient{ /*Id=1,*/ FullName="Paciente 1", NationalId="12345678", MedicalPlan=medicalPlans[0] },
                new Pacient{ /*Id=2,*/ FullName="Paciente 2", NationalId="91011121", MedicalPlan=medicalPlans[1] },
                new Pacient{ /*Id=3,*/ FullName="Paciente 3", NationalId="31415161", MedicalPlan=medicalPlans[2] },
                new Pacient{ /*Id=4,*/ FullName="Paciente 4", NationalId="71819202", MedicalPlan=medicalPlans[3] },
            };
